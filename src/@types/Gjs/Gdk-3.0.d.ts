...
declare namespace Gdk {
  ...
  export function color_parse(
    spec: string
  ): [/* returnType */ boolean, /* color */ Color];
  ...
  export function drag_find_window_for_screen(
    ...
    x_root: number,
    y_root: number
  ): [/* dest_window */ Window, /* protocol */ DragProtocol];
  ...
  export function pango_context_get_for_display(
    display: Display
  ): Pango.Context;
  ...
  export class DeviceManager {
    ...
    connect(
      ...
      callback: ($obj: DeviceManager, device: Device) => void
    ): number;
    connect_after(
      sigName: "device-added",
      callback: ($obj: DeviceManager, device: Device) => void
  ...
  export class Display {
    ...
    connect(
      ...
      callback: ($obj: Display, monitor: Monitor) => void
    ): number;
    connect_after(
      sigName: "monitor-added",
      callback: ($obj: Display, monitor: Monitor) => void
  ...
  export class DragContext {
    ...
    connect(
      ...
      callback: ($obj: DragContext, action: DragAction) => void
    ): number;
    connect_after(
      sigName: "action-changed",
      callback: ($obj: DragContext, action: DragAction) => void
    ...
    connect(
      sigName: "cancel",
      callback: ($obj: DragContext, reason: DragCancelReason) => void
    ): number;
    connect_after(
      sigName: "cancel",
      callback: ($obj: DragContext, reason: DragCancelReason) => void
    ...
    connect(
      ...
      callback: ($obj: DragContext, time: number) => void
    ): number;
    connect_after(
      sigName: "drop-performed",
      callback: ($obj: DragContext, time: number) => void
    ...
    connect(
      sigName: "notify",
      callback: ($obj: DragContext, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: DragContext, pspec: GObject.ParamSpec) => void
  ...
  export interface DrawingContext_ConstructProps
    extends GObject.Object_ConstructProps {
    clip?: cairo.Region;
    window?: Window;
  }
  ...
  export class Keymap {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: Keymap, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: Keymap, pspec: GObject.ParamSpec) => void
  ...
  export class Visual {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: Visual, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: Visual, pspec: GObject.ParamSpec) => void
  ...
  export class Window {
    ...
    connect(
      ...
      callback: ($obj: Window, width: number, height: number) => cairo.Surface
    ): number;
    connect_after(
      sigName: "create-surface",
      callback: ($obj: Window, width: number, height: number) => cairo.Surface
    ...
    connect(
      ...
      callback: ($obj: Window, embedder_x: number, embedder_y: number) => void
    ): number;
    connect_after(
      sigName: "from-embedder",
      callback: ($obj: Window, embedder_x: number, embedder_y: number) => void
    ...
    connect(
      ...
      callback: (
        $obj: Window,
        flipped_rect: object | null,
        final_rect: object | null,
        flipped_x: boolean,
        flipped_y: boolean
      ) => void
    ): number;
    ...
    connect(
      ...
      callback: ($obj: Window, x: number, y: number) => Window | null
    ): number;
    connect_after(
      sigName: "pick-embedded-child",
      callback: ($obj: Window, x: number, y: number) => Window | null
    ...
    connect(
      sigName: "to-embedder",
      callback: ($obj: Window, offscreen_x: number, offscreen_y: number) => void
    ): number;
    connect_after(
      sigName: "to-embedder",
      callback: ($obj: Window, offscreen_x: number, offscreen_y: number) => void
