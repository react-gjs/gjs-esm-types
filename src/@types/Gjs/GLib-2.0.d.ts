...
declare namespace GLib {
  ...
  export function aligned_free(mem?: object | null): void;
  ...
  export function ascii_strtod(
    nptr: string
  ): [/* returnType */ number, /* endptr */ string | null];
  ...
  export function atomic_pointer_compare_and_exchange_full(
    ...
    oldval?: object | null,
    newval?: object | null
  ): [/* returnType */ boolean, /* preval */ object];
  ...
  export function base64_encode_close(
    ...
    state: number,
    save: number
  ): [/* returnType */ number, /* out */ Gjs.byteArray.ByteArray];
  export function base64_encode_step(
    in_: Gjs.byteArray.ByteArray,
    break_lines: boolean,
    state: number,
    save: number
  ): [/* returnType */ number, /* out */ Gjs.byteArray.ByteArray];
  ...
  export function byte_array_free(
    array: Gjs.byteArray.ByteArray,
    free_segment: boolean
  ): number;
  export function byte_array_free_to_bytes(
    array: Gjs.byteArray.ByteArray
  ): Bytes;
  export function byte_array_new(): Gjs.byteArray.ByteArray;
  export function byte_array_new_take(
    data: Gjs.byteArray.ByteArray
  ): Gjs.byteArray.ByteArray;
  export function byte_array_steal(
    array: Gjs.byteArray.ByteArray
  ): [/* returnType */ number, /* len */ number | null];
  ...
  export function convert(
    ...
    to_codeset: string,
    from_codeset: string
  ): [/* returnType */ Gjs.byteArray.ByteArray, /* bytes_read */ number | null];
  ...
  export function file_get_contents(
    filename: string
  ): [/* returnType */ boolean, /* contents */ Gjs.byteArray.ByteArray];
  export function file_open_tmp(
    tmpl?: string | null
  ...
  export function filename_from_uri(
    uri: string
  ...
  export function get_charset(): [
    /* returnType */ boolean,
    /* charset */ string | null
  ];
  export function get_codeset(): string;
  export function get_console_charset(): [
    /* returnType */ boolean,
    /* charset */ string | null
  ];
  ...
  export function get_filename_charsets(): [
    /* returnType */ boolean,
    /* filename_charsets */ string[]
  ];
  ...
  export function hash_table_steal_extended(
    ...
    /* returnType */ boolean,
    /* stolen_key */ object | null,
    /* stolen_value */ object | null
  ];
  ...
  export function locale_to_utf8(
    opsysstring: Gjs.byteArray.ByteArray
  ): [
    /* returnType */ string,
    /* bytes_read */ number | null,
    /* bytes_written */ number | null
  ...
  export function shell_parse_argv(
    command_line: string
  ): [/* returnType */ boolean, /* argvp */ string[] | null];
  ...
  export function source_remove_by_user_data(
    user_data?: object | null
  ): boolean;
  ...
  export function spawn_command_line_sync(
    ...
    /* returnType */ boolean,
    /* standard_output */ Gjs.byteArray.ByteArray | null,
    /* standard_error */ Gjs.byteArray.ByteArray | null,
  ...
  ): [/* returnType */ string[], /* ascii_alternates */ string[]];
  ...
  export function unichar_compose(
    a: number,
    b: number
  ): [/* returnType */ boolean, /* ch */ number];
  export function unichar_decompose(
    ch: number
  ): [/* returnType */ boolean, /* a */ number, /* b */ number];
  export function unichar_digit_value(c: number): number;
  export function unichar_fully_decompose(
    ch: number,
    compat: boolean,
    result_len: number
  ): [/* returnType */ number, /* result */ number | null];
  ...
  export function unichar_to_utf8(
    c: number
  ): [/* returnType */ number, /* outbuf */ string | null];
  ...
  export function uri_escape_bytes(
    unescaped: Gjs.byteArray.ByteArray,
  ...
  export function utf8_to_ucs4_fast(
    str: string,
    len: number
  ): [/* returnType */ number, /* items_written */ number | null];
  ...
  export function utf8_validate(
    str: Gjs.byteArray.ByteArray
  ): [/* returnType */ boolean, /* end */ string | null];
  ...
  export function variant_type_string_scan(
    string: string,
    limit?: string | null
  ): [/* returnType */ boolean, /* endptr */ string | null];
  ...
  export interface SourceOnceFunc {
    (): void;
  }
  ...
  export class Checksum {
    ...
    static name: string;
    static new(checksum_type: ChecksumType): Checksum | null;
  ...
  export class DateTime {
    ...
    static new_from_iso8601(
      text: string,
      default_tz?: TimeZone | null
    ): DateTime | null;
  ...
  export class IOChannel {
    ...
    read_to_end(): [
      /* returnType */ IOStatus,
      /* str_return */ Gjs.byteArray.ByteArray
    ];
  ...
  export class TimeZone {
    ...
    static new(identifier?: string | null): TimeZone;
    static new_identifier(identifier?: string | null): TimeZone | null;
