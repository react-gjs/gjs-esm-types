...
declare namespace Gdk {
  ...
  export function cairo_rectangle(
    cr: cairo.Context,
    rectangle: Rectangle
  ): void;
  ...
  export function content_deserialize_finish(
  ...
  export function paintable_new_empty(
  ...
  export function pixbuf_get_from_texture(
    texture: Texture
  ): GdkPixbuf.Pixbuf | null;
  ...
  export interface AppLaunchContext_ConstructProps
    extends Gio.AppLaunchContext_ConstructProps {
    display?: Display;
  }
  ...
  export interface CairoContext_ConstructProps
    extends DrawContext_ConstructProps {}
  ...
  export interface Clipboard_ConstructProps
  ...
  export interface ContentDeserializer_ConstructProps
    extends GObject.Object_ConstructProps {}
  export class ContentDeserializer {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: ContentDeserializer, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: ContentDeserializer, pspec: GObject.ParamSpec) => void
  ...
  export interface ContentProvider_ConstructProps
    extends GObject.Object_ConstructProps {}
  export class ContentProvider {
    ...
    connect(
      ...
      callback: ($obj: ContentProvider) => void
    ): number;
    connect_after(
      sigName: "content-changed",
      callback: ($obj: ContentProvider) => void
  ...
  export interface ContentSerializer_ConstructProps
    extends GObject.Object_ConstructProps {}
  export class ContentSerializer {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: ContentSerializer, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: ContentSerializer, pspec: GObject.ParamSpec) => void
  ...
  export class Cursor {
    ...
    static new_from_name(name: string, fallback?: Cursor | null): Cursor | null;
  ...
  export class Device {
    ...
    connect(
      ...
      callback: ($obj: Device, tool: DeviceTool) => void
    ): number;
    connect_after(
      sigName: "tool-changed",
      callback: ($obj: Device, tool: DeviceTool) => void
  ...
  export interface DeviceTool_ConstructProps
    extends GObject.Object_ConstructProps {
    axes?: AxisFlags;
    hardware_id?: number;
    serial?: number;
  ...
  export class Display {
    ...
    connect(
      sigName: "closed",
      callback: ($obj: Display, is_error: boolean) => void
    ): number;
    connect_after(
      sigName: "closed",
      callback: ($obj: Display, is_error: boolean) => void
    ...
    connect(
      sigName: "seat-added",
      callback: ($obj: Display, seat: Seat) => void
    ): number;
    connect_after(
      sigName: "seat-added",
      callback: ($obj: Display, seat: Seat) => void
    ...
    connect(
      ...
      callback: ($obj: Display, setting: string) => void
    ): number;
    connect_after(
      sigName: "setting-changed",
      callback: ($obj: Display, setting: string) => void
  ...
  export class DisplayManager {
    ...
    connect(
      ...
      callback: ($obj: DisplayManager, display: Display) => void
    ): number;
    connect_after(
      sigName: "display-opened",
      callback: ($obj: DisplayManager, display: Display) => void
  ...
  export class Drag {
    ...
    connect(
      sigName: "cancel",
      callback: ($obj: Drag, reason: DragCancelReason) => void
    ): number;
    connect_after(
      sigName: "cancel",
      callback: ($obj: Drag, reason: DragCancelReason) => void
  ...
  export interface DrawContext_ConstructProps
    extends GObject.Object_ConstructProps {
    display?: Display;
    surface?: Surface;
  }
  ...
  export class Drop {
    ...
    read_finish(
      result: Gio.AsyncResult
    ): [/* returnType */ Gio.InputStream | null, /* out_mime_type */ string];
    read_value_async(
      type: GObject.Type,
      io_priority: number,
      cancellable?: Gio.Cancellable | null,
  ...
  export class FrameClock {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: FrameClock, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: FrameClock, pspec: GObject.ParamSpec) => void
  ...
  export class GLTexture {
    /* Properties of Gdk.Texture */
    /* Fields of GObject.Object */
    g_type_instance: GObject.TypeInstance;
    /* Methods of Gdk.GLTexture */
    release(): void;
    /* Methods of Gdk.Texture */
    download(data: Gjs.byteArray.ByteArray, stride: number): void;
    get_height(): number;
    get_width(): number;
    save_to_png(filename: string): boolean;
    save_to_png_bytes(): Gjs.byteArray.ByteArray;
    save_to_tiff(filename: string): boolean;
    save_to_tiff_bytes(): Gjs.byteArray.ByteArray;
    /* Methods of GObject.Object */
    bind_property(
      source_property: string,
      target: GObject.Object,
    ...
    load(
      size: number,
      cancellable?: Gio.Cancellable | null
    ): [/* returnType */ Gio.InputStream, /* type */ string | null];
    load_async(
      size: number,
      cancellable?: Gio.Cancellable | null,
      callback?: Gio.AsyncReadyCallback | null
  ...
  export interface MemoryTexture_ConstructProps
    extends Texture_ConstructProps {}
  export class MemoryTexture {
    ...
    connect(
      sigName: "invalidate-contents",
      callback: ($obj: MemoryTexture) => void
    ): number;
    connect_after(
      sigName: "invalidate-contents",
      callback: ($obj: MemoryTexture) => void
  ...
  export interface Monitor_ConstructProps
    extends GObject.Object_ConstructProps {
    display?: Display;
  }
  ...
  export class Seat {
    ...
    connect(
      ...
      callback: ($obj: Seat, device: Device) => void
    ): number;
    connect_after(
      sigName: "device-added",
      callback: ($obj: Seat, device: Device) => void
    ...
    connect(
      sigName: "tool-added",
      callback: ($obj: Seat, tool: DeviceTool) => void
    ): number;
    connect_after(
      sigName: "tool-added",
      callback: ($obj: Seat, tool: DeviceTool) => void
  ...
  export interface Snapshot_ConstructProps
    extends GObject.Object_ConstructProps {}
  export class Snapshot {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: Snapshot, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: Snapshot, pspec: GObject.ParamSpec) => void
  ...
  export interface Surface_ConstructProps
    extends GObject.Object_ConstructProps {
    cursor?: Cursor;
    display?: Display;
  ...
  export class Surface {
    ...
    connect(
      ...
      callback: ($obj: Surface, monitor: Monitor) => void
    ): number;
    connect_after(
      sigName: "enter-monitor",
      callback: ($obj: Surface, monitor: Monitor) => void
    ...
    connect(
      sigName: "event",
      callback: ($obj: Surface, event: Event) => boolean
    ): number;
    connect_after(
      sigName: "event",
      callback: ($obj: Surface, event: Event) => boolean
    ...
    connect(
      sigName: "layout",
      callback: ($obj: Surface, width: number, height: number) => void
    ): number;
    connect_after(
      sigName: "layout",
      callback: ($obj: Surface, width: number, height: number) => void
    ...
    connect(
      sigName: "render",
      callback: ($obj: Surface, region: cairo.Region) => boolean
    ): number;
    connect_after(
      sigName: "render",
      callback: ($obj: Surface, region: cairo.Region) => boolean
  ...
  export interface Texture_ConstructProps
    extends GObject.Object_ConstructProps {
    height?: number;
    width?: number;
  }
  export class Texture {
    ...
    static new_from_bytes(bytes: Gjs.byteArray.ByteArray): Texture;
  ...
  export interface VulkanContext_ConstructProps
    extends DrawContext_ConstructProps {}
  export class VulkanContext {
    ...
    connect(
      ...
      callback: ($obj: VulkanContext) => void
    ): number;
    connect_after(
      sigName: "images-updated",
      callback: ($obj: VulkanContext) => void
