...
declare namespace Soup {
  ...
  export function str_case_equal(
    v1?: object | null,
    v2?: object | null
  ): boolean;
  ...
  export function xmlrpc_parse_request(
    method_call: string,
    length: number
  ): [/* returnType */ string, /* params */ XMLRPCParams];
  ...
  export class HSTSEnforcer {
    ...
    connect(
      ...
      callback: ($obj: HSTSEnforcer, message: Message) => void
    ): number;
    connect_after(
      sigName: "hsts-enforced",
      callback: ($obj: HSTSEnforcer, message: Message) => void
  ...
  export class Message {
    ...
    set_request(
      content_type: string | null,
      req_use: MemoryUse,
      req_body: Gjs.byteArray.ByteArray | null
    ): void;
    set_response(
      content_type: string | null,
      resp_use: MemoryUse,
    ...
    connect(
      sigName: "got-chunk",
      callback: ($obj: Message, chunk: Buffer) => void
    ): number;
    connect_after(
      sigName: "got-chunk",
      callback: ($obj: Message, chunk: Buffer) => void
  ...
  export class Requester {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: Requester, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: Requester, pspec: GObject.ParamSpec) => void
  ...
  export class Server {
    ...
    connect(
      ...
      callback: ($obj: Server, message: Message, client: ClientContext) => void
    ): number;
    connect_after(
      sigName: "request-aborted",
      callback: ($obj: Server, message: Message, client: ClientContext) => void
  ...
  export class Session {
    ...
    connect(
      ...
      callback: ($obj: Session, connection: GObject.Object) => void
    ): number;
    connect_after(
      sigName: "connection-created",
      callback: ($obj: Session, connection: GObject.Object) => void
    ...
    connect(
      sigName: "request-started",
      callback: ($obj: Session, msg: Message, socket: Socket) => void
    ): number;
    connect_after(
      sigName: "request-started",
      callback: ($obj: Session, msg: Message, socket: Socket) => void
  ...
  export class SessionAsync {
    ...
    connect(
      sigName: "request-queued",
      callback: ($obj: SessionAsync, msg: Message) => void
    ): number;
    connect_after(
      sigName: "request-queued",
      callback: ($obj: SessionAsync, msg: Message) => void
  ...
  export class SessionSync {
    ...
    connect(
      sigName: "request-queued",
      callback: ($obj: SessionSync, msg: Message) => void
    ): number;
    connect_after(
      sigName: "request-queued",
      callback: ($obj: SessionSync, msg: Message) => void
  ...
  export class Socket {
    ...
    connect(
      ...
      callback: ($obj: Socket, new_: Socket) => void
    ): number;
    connect_after(
      sigName: "new-connection",
      callback: ($obj: Socket, new_: Socket) => void
