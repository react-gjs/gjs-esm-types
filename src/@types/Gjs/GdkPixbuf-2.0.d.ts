...
declare namespace GdkPixbuf {
  ...
  export interface PixbufModuleIncrementLoadFunc {
    (context: object | null, buf: Gjs.byteArray.ByteArray): boolean;
  }
  ...
  export class Pixbuf {
    ...
    ): [/* returnType */ boolean, /* buffer */ Gjs.byteArray.ByteArray];
    save_to_callbackv(
    ...
    static new_from_file(filename: string): Pixbuf | null;
    ...
    static new_from_inline(
      data: Gjs.byteArray.ByteArray,
      copy_pixels: boolean
    ): Pixbuf;
    static new_from_resource(resource_path: string): Pixbuf | null;
    ...
    static new_from_stream_finish(async_result: Gio.AsyncResult): Pixbuf | null;
  ...
  export class PixbufAnimation {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: PixbufAnimation, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: PixbufAnimation, pspec: GObject.ParamSpec) => void
    ...
    static new_from_file(filename: string): PixbufAnimation | null;
    static new_from_resource(resource_path: string): PixbufAnimation | null;
    static new_from_stream(
      stream: Gio.InputStream,
      cancellable?: Gio.Cancellable | null
  ...
  export class PixbufAnimationIter {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: PixbufAnimationIter, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: PixbufAnimationIter, pspec: GObject.ParamSpec) => void
  ...
  export class PixbufLoader {
    ...
    connect(
      ...
      callback: ($obj: PixbufLoader) => void
    ): number;
    connect_after(
      sigName: "area-prepared",
      callback: ($obj: PixbufLoader) => void
    ...
    connect(
      ...
      callback: ($obj: PixbufLoader, width: number, height: number) => void
    ): number;
    connect_after(
      sigName: "size-prepared",
      callback: ($obj: PixbufLoader, width: number, height: number) => void
    ...
    connect(
      sigName: "notify",
      callback: ($obj: PixbufLoader, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: PixbufLoader, pspec: GObject.ParamSpec) => void
  ...
  export interface PixbufNonAnim_ConstructProps
  ...
  export class PixbufNonAnim {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: PixbufNonAnim, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: PixbufNonAnim, pspec: GObject.ParamSpec) => void
  ...
  export interface PixbufSimpleAnimIter_ConstructProps
    extends PixbufAnimationIter_ConstructProps {}
  export class PixbufSimpleAnimIter {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: PixbufSimpleAnimIter, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: PixbufSimpleAnimIter, pspec: GObject.ParamSpec) => void
