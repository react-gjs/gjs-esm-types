...
declare namespace HarfBuzz {
  ...
  export function aat_layout_feature_type_get_selector_infos(
    ...
    /* returnType */ number,
    /* selectors */ aat_layout_feature_selector_info_t[] | null,
    /* default_index */ number | null
  ];
  export function aat_layout_get_feature_types(
    face: face_t,
    start_offset: number
  ...
  export function blob_create_sub_blob(
    parent: blob_t,
    offset: number,
    length: number
  ): blob_t;
  ...
  export function buffer_add_latin1(
    buffer: buffer_t,
    text: Gjs.byteArray.ByteArray,
    item_offset: number,
    item_length: number
  ): void;
  export function buffer_add_utf16(
    buffer: buffer_t,
    text: number[],
    item_offset: number,
    item_length: number
  ): void;
  export function buffer_add_utf32(
    buffer: buffer_t,
    text: number[],
    item_offset: number,
    item_length: number
  ...
  export function buffer_get_cluster_level(
    buffer: buffer_t
  ): buffer_cluster_level_t;
  export function buffer_get_content_type(
    buffer: buffer_t
  ...
  export function buffer_get_glyph_positions(
    buffer: buffer_t
  ): glyph_position_t[];
  ...
  export function buffer_get_replacement_codepoint(
    buffer: buffer_t
  ): codepoint_t;
  export function buffer_get_script(buffer: buffer_t): script_t;
  export function buffer_get_segment_properties(
    buffer: buffer_t
  ...
  export function buffer_reverse_range(
    buffer: buffer_t,
    start: number,
    end: number
  ): void;
  export function buffer_serialize(
    ...
    /* returnType */ number,
    /* buf */ Gjs.byteArray.ByteArray,
    /* buf_consumed */ number | null
  ];
  export function buffer_serialize_format_from_string(
    str: Gjs.byteArray.ByteArray
  ): buffer_serialize_format_t;
  export function buffer_serialize_format_to_string(
    format: buffer_serialize_format_t
  ): string;
  ...
  export function buffer_set_cluster_level(
    buffer: buffer_t,
    cluster_level: buffer_cluster_level_t
  ): void;
  export function buffer_set_content_type(
    buffer: buffer_t,
    content_type: buffer_content_type_t
  ): void;
  export function buffer_set_direction(
    buffer: buffer_t,
    direction: direction_t
  ): void;
  export function buffer_set_flags(
    buffer: buffer_t,
    flags: buffer_flags_t
  ): void;
  export function buffer_set_invisible_glyph(
    buffer: buffer_t,
    invisible: codepoint_t
  ): void;
  export function buffer_set_language(
    buffer: buffer_t,
    language: language_t
  ): void;
  ...
  export function buffer_set_not_found_glyph(
    buffer: buffer_t,
    not_found: codepoint_t
  ): void;
  export function buffer_set_replacement_codepoint(
    buffer: buffer_t,
    replacement: codepoint_t
  ): void;
  export function buffer_set_script(buffer: buffer_t, script: script_t): void;
  export function buffer_set_segment_properties(
    buffer: buffer_t,
    props: segment_properties_t
  ): void;
  export function buffer_set_unicode_funcs(
    buffer: buffer_t,
  ...
  export function color_line_get_color_stops(
    color_line: color_line_t,
    start: number
  ): [/* returnType */ number, /* color_stops */ color_stop_t[] | null];
  export function color_line_get_extend(
    color_line: color_line_t
  ): paint_extend_t;
  export function direction_from_string(
    str: Gjs.byteArray.ByteArray
  ): direction_t;
  export function direction_to_string(direction: direction_t): string;
  export function draw_close_path(
    dfuncs: draw_funcs_t,
    draw_data: object | null,
    st: draw_state_t
  ): void;
  ...
  export function face_builder_add_table(
    face: face_t,
    tag: tag_t,
    blob: blob_t
  ): bool_t;
  ...
  export function face_collect_nominal_glyph_mapping(
    face: face_t
  ): [/* mapping */ map_t, /* unicodes */ set_t | null];
  export function face_collect_unicodes(face: face_t): /* out */ set_t;
  export function face_collect_variation_selectors(
    face: face_t
  ): /* out */ set_t;
  export function face_collect_variation_unicodes(
    face: face_t,
  ...
  export function face_get_table_tags(
    face: face_t,
    start_offset: number
  ...
  export function feature_from_string(
    str: Gjs.byteArray.ByteArray
  ...
  export function font_draw_glyph(
    font: font_t,
    glyph: codepoint_t,
    dfuncs: draw_funcs_t,
    draw_data?: object | null
  ...
  export function font_funcs_set_draw_glyph_func(
    ffuncs: font_funcs_t,
  ...
  export function font_funcs_set_paint_glyph_func(
    ffuncs: font_funcs_t,
  ...
  export function font_get_extents_for_direction(
    font: font_t,
    direction: direction_t
  ...
  export function font_get_glyph_extents(
    font: font_t,
    glyph: codepoint_t
  ...
  export function font_get_glyph_from_name(
    font: font_t,
    name: string[]
  ): [/* returnType */ bool_t, /* glyph */ codepoint_t];
  export function font_get_glyph_h_advance(
    font: font_t,
    glyph: codepoint_t
  ): position_t;
  ...
  export function font_get_glyph_h_kerning(
    font: font_t,
    left_glyph: codepoint_t,
    right_glyph: codepoint_t
  ): position_t;
  export function font_get_glyph_h_origin(
    font: font_t,
    glyph: codepoint_t
  ): [/* returnType */ bool_t, /* x */ position_t, /* y */ position_t];
  ...
  export function font_get_glyph_name(
    font: font_t,
    glyph: codepoint_t
  ...
  export function font_get_glyph_v_advance(
    font: font_t,
    glyph: codepoint_t
  ): position_t;
  ...
  export function font_get_glyph_v_kerning(
    font: font_t,
    top_glyph: codepoint_t,
    bottom_glyph: codepoint_t
  ): position_t;
  export function font_get_glyph_v_origin(
    font: font_t,
    glyph: codepoint_t
  ): [/* returnType */ bool_t, /* x */ position_t, /* y */ position_t];
  export function font_get_h_extents(
    font: font_t
  ): [/* returnType */ bool_t, /* extents */ font_extents_t];
  export function font_get_nominal_glyph(
    font: font_t,
    unicode: codepoint_t
  ): [/* returnType */ bool_t, /* glyph */ codepoint_t];
  ...
  export function font_glyph_from_string(
    font: font_t,
    s: Gjs.byteArray.ByteArray
  ): [/* returnType */ bool_t, /* glyph */ codepoint_t];
  export function font_glyph_to_string(
    font: font_t,
    glyph: codepoint_t
  ): /* s */ string[];
  export function font_is_immutable(font: font_t): bool_t;
  export function font_make_immutable(font: font_t): void;
  export function font_paint_glyph(
    font: font_t,
    glyph: codepoint_t,
    pfuncs: paint_funcs_t,
    paint_data: object | null,
  ...
  export function font_set_funcs_data(
    font: font_t,
    font_data?: object | null
  ): void;
  export function font_set_parent(font: font_t, parent: font_t): void;
  export function font_set_ppem(
    font: font_t,
    x_ppem: number,
    y_ppem: number
  ): void;
  export function font_set_ptem(font: font_t, ptem: number): void;
  export function font_set_scale(
    font: font_t,
    x_scale: number,
    y_scale: number
  ): void;
  export function font_set_synthetic_bold(
    font: font_t,
    x_embolden: number,
    y_embolden: number,
    in_place: bool_t
  ...
  export function font_set_var_coords_design(
    font: font_t,
    coords: number[]
  ): void;
  export function font_set_var_coords_normalized(
    font: font_t,
    coords: number[]
  ): void;
  export function font_set_var_named_instance(
    font: font_t,
    instance_index: number
  ): void;
  export function font_set_variations(
    font: font_t,
  ...
  export function ft_face_create(ft_face: freetype2.Face): face_t;
  ...
  export function ft_font_create(ft_face: freetype2.Face): font_t;
  ...
  export function ft_font_set_load_flags(
    font: font_t,
    load_flags: number
  ): void;
  ...
  export function language_matches(
    language: language_t,
    specific: language_t
  ): bool_t;
  ...
  export function map_next(
    map: map_t,
    idx: number
  ): [/* returnType */ bool_t, /* key */ codepoint_t, /* value */ codepoint_t];
  ...
  export function ot_color_glyph_has_paint(
    face: face_t,
    glyph: codepoint_t
  ): bool_t;
  export function ot_color_glyph_reference_png(
    font: font_t,
    glyph: codepoint_t
  ): blob_t;
  export function ot_color_glyph_reference_svg(
    face: face_t,
    glyph: codepoint_t
  ): blob_t;
  ...
  export function ot_color_palette_color_get_name_id(
    face: face_t,
    color_index: number
  ): ot_name_id_t;
  ...
  export function ot_color_palette_get_flags(
    face: face_t,
    palette_index: number
  ): ot_color_palette_flags_t;
  export function ot_color_palette_get_name_id(
    face: face_t,
    palette_index: number
  ): ot_name_id_t;
  ...
  export function ot_layout_get_attach_points(
    face: face_t,
    glyph: codepoint_t,
    start_offset: number
  ...
  export function ot_layout_get_glyph_class(
    face: face_t,
    glyph: codepoint_t
  ): ot_layout_glyph_class_t;
  export function ot_layout_get_glyphs_in_class(
    face: face_t,
    klass: ot_layout_glyph_class_t
  ): /* glyphs */ set_t;
  export function ot_layout_get_horizontal_baseline_tag_for_script(
    script: script_t
  ...
  export function ot_layout_get_size_params(
    face: face_t
  ): [
    /* returnType */ bool_t,
    /* design_size */ number,
  ...
  export function ot_layout_lookup_get_optical_bound(
    font: font_t,
    lookup_index: number,
    direction: direction_t,
    glyph: codepoint_t
  ): position_t;
  export function ot_layout_lookup_substitute_closure(
    face: face_t,
    lookup_index: number
  ): /* glyphs */ set_t;
  ...
  export function ot_layout_lookups_substitute_closure(
    face: face_t,
    lookups: set_t
  ): /* glyphs */ set_t;
  ...
  export function ot_layout_script_select_language2(
    face: face_t,
    table_tag: tag_t,
    script_index: number,
    language_count: number,
  ...
  export function ot_layout_table_find_script(
    face: face_t,
    table_tag: tag_t,
    script_tag: tag_t
  ...
  export function ot_layout_table_get_lookup_count(
    face: face_t,
    table_tag: tag_t
  ): number;
  ...
  export function ot_math_get_constant(
    font: font_t,
  ...
  export function ot_math_get_glyph_italics_correction(
    font: font_t,
    glyph: codepoint_t
  ): position_t;
  ...
  export function ot_math_get_glyph_top_accent_attachment(
    font: font_t,
    glyph: codepoint_t
  ): position_t;
  ...
  export function ot_math_get_min_connector_overlap(
    font: font_t,
    direction: direction_t
  ): position_t;
  export function ot_math_has_data(face: face_t): bool_t;
  export function ot_math_is_glyph_extended_shape(
    face: face_t,
    glyph: codepoint_t
  ): bool_t;
  export function ot_meta_get_entry_tags(
    face: face_t,
    start_offset: number
  ): [/* returnType */ number, /* entries */ ot_meta_tag_t[]];
  export function ot_meta_reference_entry(
    face: face_t,
    meta_tag: ot_meta_tag_t
  ): blob_t;
  export function ot_metrics_get_position(
    font: font_t,
    metrics_tag: ot_metrics_tag_t
  ): [/* returnType */ bool_t, /* position */ position_t | null];
  export function ot_metrics_get_position_with_fallback(
    font: font_t,
    metrics_tag: ot_metrics_tag_t
  ): /* position */ position_t | null;
  export function ot_metrics_get_variation(
    font: font_t,
    metrics_tag: ot_metrics_tag_t
  ): number;
  export function ot_metrics_get_x_variation(
    font: font_t,
    metrics_tag: ot_metrics_tag_t
  ): position_t;
  export function ot_metrics_get_y_variation(
    font: font_t,
    metrics_tag: ot_metrics_tag_t
  ): position_t;
  export function ot_name_get_utf16(
    face: face_t,
    name_id: ot_name_id_t,
    language: language_t
  ): [/* returnType */ number, /* text */ number[]];
  export function ot_name_get_utf32(
    face: face_t,
    name_id: ot_name_id_t,
    language: language_t
  ): [/* returnType */ number, /* text */ number[]];
  export function ot_name_get_utf8(
    face: face_t,
    name_id: ot_name_id_t,
    language: language_t
  ): [/* returnType */ number, /* text */ string[]];
  export function ot_name_list_names(face: face_t): ot_name_entry_t[];
  export function ot_shape_glyphs_closure(
    font: font_t,
    buffer: buffer_t,
    features: feature_t[]
  ): /* glyphs */ set_t;
  export function ot_shape_plan_collect_lookups(
  ...
  export function ot_tags_from_script(
    script: script_t
  ...
  export function ot_var_named_instance_get_design_coords(
    face: face_t,
    instance_index: number
  ): [/* returnType */ number, /* coords */ number[]];
  export function ot_var_named_instance_get_postscript_name_id(
    face: face_t,
    instance_index: number
  ): ot_name_id_t;
  export function ot_var_named_instance_get_subfamily_name_id(
    face: face_t,
    instance_index: number
  ): ot_name_id_t;
  export function ot_var_normalize_coords(
    face: face_t,
    coords_length: number,
    design_coords: number
  ): /* normalized_coords */ number;
  export function ot_var_normalize_variations(
    face: face_t,
    variations: variation_t,
    variations_length: number
  ): /* coords */ number[];
  export function paint_color(
    funcs: paint_funcs_t,
    paint_data: object | null,
    is_foreground: bool_t,
    color: color_t
  ): void;
  export function paint_custom_palette_color(
    funcs: paint_funcs_t,
    paint_data: object | null,
    color_index: number
  ...
  export function paint_funcs_set_color_func(
    funcs: paint_funcs_t,
    func: paint_color_func_t
  ): void;
  export function paint_funcs_set_custom_palette_color_func(
    funcs: paint_funcs_t,
    func: paint_custom_palette_color_func_t
  ): void;
  export function paint_funcs_set_image_func(
    funcs: paint_funcs_t,
    func: paint_image_func_t
  ): void;
  export function paint_funcs_set_linear_gradient_func(
    funcs: paint_funcs_t,
    func: paint_linear_gradient_func_t
  ): void;
  export function paint_funcs_set_pop_clip_func(
    funcs: paint_funcs_t,
    func: paint_pop_clip_func_t
  ): void;
  export function paint_funcs_set_pop_group_func(
    funcs: paint_funcs_t,
    func: paint_pop_group_func_t
  ): void;
  export function paint_funcs_set_pop_transform_func(
    funcs: paint_funcs_t,
    func: paint_pop_transform_func_t
  ): void;
  export function paint_funcs_set_push_clip_glyph_func(
    funcs: paint_funcs_t,
    func: paint_push_clip_glyph_func_t
  ): void;
  export function paint_funcs_set_push_clip_rectangle_func(
    funcs: paint_funcs_t,
    func: paint_push_clip_rectangle_func_t
  ): void;
  export function paint_funcs_set_push_group_func(
    funcs: paint_funcs_t,
    func: paint_push_group_func_t
  ): void;
  export function paint_funcs_set_push_transform_func(
    funcs: paint_funcs_t,
    func: paint_push_transform_func_t
  ): void;
  export function paint_funcs_set_radial_gradient_func(
    funcs: paint_funcs_t,
    func: paint_radial_gradient_func_t
  ): void;
  export function paint_funcs_set_sweep_gradient_func(
    funcs: paint_funcs_t,
    func: paint_sweep_gradient_func_t
  ): void;
  export function paint_image(
    funcs: paint_funcs_t,
    paint_data: object | null,
    image: blob_t,
    width: number,
  ...
  export function paint_linear_gradient(
    funcs: paint_funcs_t,
    paint_data: object | null,
    color_line: color_line_t,
    x0: number,
  ...
  export function paint_pop_clip(
    funcs: paint_funcs_t,
    paint_data?: object | null
  ): void;
  export function paint_pop_group(
    funcs: paint_funcs_t,
    paint_data: object | null,
    mode: paint_composite_mode_t
  ): void;
  export function paint_pop_transform(
    funcs: paint_funcs_t,
    paint_data?: object | null
  ): void;
  export function paint_push_clip_glyph(
    funcs: paint_funcs_t,
    paint_data: object | null,
    glyph: codepoint_t,
    font: font_t
  ): void;
  export function paint_push_clip_rectangle(
    funcs: paint_funcs_t,
    paint_data: object | null,
    xmin: number,
    ymin: number,
  ...
  export function paint_push_group(
    funcs: paint_funcs_t,
    paint_data?: object | null
  ): void;
  export function paint_push_transform(
    funcs: paint_funcs_t,
    paint_data: object | null,
    xx: number,
    yx: number,
  ...
  export function paint_radial_gradient(
    funcs: paint_funcs_t,
    paint_data: object | null,
    color_line: color_line_t,
    x0: number,
  ...
  export function paint_sweep_gradient(
    funcs: paint_funcs_t,
    paint_data: object | null,
    color_line: color_line_t,
    x0: number,
  ...
  export function set_next_many(
    set: set_t,
    codepoint: codepoint_t,
    out: codepoint_t[]
  ): number;
  export function set_next_range(
    set: set_t,
    last: codepoint_t
  ): [/* returnType */ bool_t, /* first */ codepoint_t];
  export function set_previous(set: set_t, codepoint: codepoint_t): bool_t;
  export function set_previous_range(
    set: set_t,
    first: codepoint_t
  ): [/* returnType */ bool_t, /* last */ codepoint_t];
  ...
  export function unicode_combining_class(
    ufuncs: unicode_funcs_t,
    unicode: codepoint_t
  ): unicode_combining_class_t;
  export function unicode_compose(
    ufuncs: unicode_funcs_t,
    a: codepoint_t,
    b: codepoint_t
  ): [/* returnType */ bool_t, /* ab */ codepoint_t];
  export function unicode_decompose(
    ufuncs: unicode_funcs_t,
    ab: codepoint_t
  ): [/* returnType */ bool_t, /* a */ codepoint_t, /* b */ codepoint_t];
  export function unicode_decompose_compatibility(
    ufuncs: unicode_funcs_t,
    u: codepoint_t
  ): [/* returnType */ number, /* decomposed */ codepoint_t];
  export function unicode_eastasian_width(
    ufuncs: unicode_funcs_t,
    unicode: codepoint_t
  ): number;
  export function unicode_funcs_create(
  ...
  export function unicode_funcs_get_parent(
    ufuncs: unicode_funcs_t
  ): unicode_funcs_t;
  ...
  export function unicode_general_category(
    ufuncs: unicode_funcs_t,
    unicode: codepoint_t
  ): unicode_general_category_t;
  export function unicode_mirroring(
    ufuncs: unicode_funcs_t,
    unicode: codepoint_t
  ): codepoint_t;
  export function unicode_script(
    ufuncs: unicode_funcs_t,
    unicode: codepoint_t
  ): script_t;
  export function variation_from_string(
    str: Gjs.byteArray.ByteArray
  ): [/* returnType */ bool_t, /* variation */ variation_t];
  export function variation_to_string(
