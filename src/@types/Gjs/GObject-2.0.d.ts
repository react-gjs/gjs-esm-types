...
declare namespace GObject {
  ...
  export function enum_get_value(
  ...
  export function param_value_is_valid(pspec: ParamSpec, value: Value): boolean;
  ...
  export function source_set_closure(
    source: GLib.Source,
    closure: Closure
  ): void;
  ...
  export function type_interface_instantiatable_prerequisite(
    interface_type: Type
  ): Type;
  ...
  export function value_type_compatible(
    src_type: Type,
    dest_type: Type
  ): boolean;
  ...
  export function registerClass<T extends MetaInfo | Function>(
    a: T,
    b?: Function
  ): Function;
  ...
  export interface BindingGroup_ConstructProps extends Object_ConstructProps {
    source?: Object;
  }
  export class BindingGroup {
    /* Properties of GObject.BindingGroup */
    source: Object;
    /* Fields of GObject.Object */
    g_type_instance: TypeInstance;
    /* Methods of GObject.BindingGroup */
    bind(
      source_property: string,
      target: Object,
      target_property: string,
  ...
  export class InitiallyUnowned {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: InitiallyUnowned, pspec: ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: InitiallyUnowned, pspec: ParamSpec) => void
  ...
  export class Object {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: Object, pspec: ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: Object, pspec: ParamSpec) => void
  ...
  export interface SignalGroup_ConstructProps extends Object_ConstructProps {
    target?: Object;
    target_type?: Type;
  }
  export class SignalGroup {
    /* Properties of GObject.SignalGroup */
    target: Object;
    /* Fields of GObject.Object */
    g_type_instance: TypeInstance;
    /* Methods of GObject.SignalGroup */
    block(): void;
    connect_closure(
      detailed_signal: string,
      closure: Closure,
    ...
    /* Signals of GObject.SignalGroup */
    connect(
      sigName: "bind",
      callback: ($obj: SignalGroup, instance: Object) => void
    ): number;
    connect_after(
      sigName: "bind",
      callback: ($obj: SignalGroup, instance: Object) => void
  ...
  export class TypeModule {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: TypeModule, pspec: ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: TypeModule, pspec: ParamSpec) => void
