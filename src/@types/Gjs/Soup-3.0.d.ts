...
declare namespace Soup {
  ...
  export function date_time_new_from_http_string(
    date_string: string
  ): GLib.DateTime | null;
  export function date_time_to_string(
    date: GLib.DateTime,
    format: DateFormat
  ): string;
  ...
  export function header_parse_quality_list(
    header: string
  ): [/* returnType */ string[], /* unacceptable */ string[] | null];
  ...
  export function uri_decode_data_uri(
    uri: string
  ): [
    /* returnType */ Gjs.byteArray.ByteArray,
    /* content_type */ string | null
  ];
  ...
  export interface AuthDomainDigestAuthCallback {
    (domain: AuthDomainDigest, msg: ServerMessage, username: string):
      | string
      | null;
  }
  ...
  export interface AuthDomainBasic_ConstructProps
    extends AuthDomain_ConstructProps {
  ...
  export class AuthManager {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: AuthManager, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: AuthManager, pspec: GObject.ParamSpec) => void
  ...
  export class ContentDecoder {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: ContentDecoder, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: ContentDecoder, pspec: GObject.ParamSpec) => void
  ...
  export class ContentSniffer {
    ...
    ): [/* returnType */ string, /* params */ GLib.HashTable | null];
    /* Methods of GObject.Object */
    bind_property(
      source_property: string,
      target: GObject.Object,
    ...
    connect(
      sigName: "notify",
      callback: ($obj: ContentSniffer, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: ContentSniffer, pspec: GObject.ParamSpec) => void
  ...
  export interface CookieJarText_ConstructProps
    extends CookieJar_ConstructProps {
    filename?: string;
  }
  ...
  export interface HSTSEnforcer_ConstructProps
    extends GObject.Object_ConstructProps {}
  export class HSTSEnforcer {
    ...
    connect(
      sigName: "notify",
      callback: ($obj: HSTSEnforcer, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: HSTSEnforcer, pspec: GObject.ParamSpec) => void
  ...
  export interface HSTSEnforcerDB_ConstructProps
    extends HSTSEnforcer_ConstructProps {
    filename?: string;
  }
  ...
  export class Message {
    ...
    connect(
      ...
      callback: ($obj: Message, auth: Auth, retrying: boolean) => boolean
    ): number;
    connect_after(
      sigName: "authenticate",
      callback: ($obj: Message, auth: Auth, retrying: boolean) => boolean
    ...
    connect(
      ...
      callback: ($obj: Message, type: string, params: GLib.HashTable) => void
    ): number;
    connect_after(
      sigName: "content-sniffed",
      callback: ($obj: Message, type: string, params: GLib.HashTable) => void
    ...
    connect(
      ...
      callback: ($obj: Message, tls_password: Gio.TlsPassword) => boolean
    ): number;
    connect_after(
      sigName: "request-certificate-password",
      callback: ($obj: Message, tls_password: Gio.TlsPassword) => boolean
    ...
    connect(
      ...
      callback: ($obj: Message, chunk_size: number) => void
    ): number;
    connect_after(
      sigName: "wrote-body-data",
      callback: ($obj: Message, chunk_size: number) => void
  ...
  export interface MultipartInputStream_ConstructProps
    extends Gio.FilterInputStream_ConstructProps {
    message?: Message;
  }
  ...
  export class Server {
    ...
    connect(
      ...
      callback: ($obj: Server, message: ServerMessage) => void
    ): number;
    connect_after(
      sigName: "request-aborted",
      callback: ($obj: Server, message: ServerMessage) => void
  ...
  export interface ServerMessage_ConstructProps
    extends GObject.Object_ConstructProps {}
  export class ServerMessage {
    /* Properties of Soup.ServerMessage */
    readonly tls_peer_certificate: Gio.TlsCertificate;
    readonly tls_peer_certificate_errors: Gio.TlsCertificateFlags;
    /* Fields of GObject.Object */
    g_type_instance: GObject.TypeInstance;
    /* Methods of Soup.ServerMessage */
    get_http_version(): HTTPVersion;
    ...
    set_response(
      content_type: string | null,
      resp_use: MemoryUse,
      resp_body: Gjs.byteArray.ByteArray | null
    ): void;
    ...
    connect(
      sigName: "connected",
      callback: ($obj: ServerMessage) => void
    ): number;
    connect_after(
      sigName: "connected",
      callback: ($obj: ServerMessage) => void
    ...
    connect(
      sigName: "got-chunk",
      callback: ($obj: ServerMessage, chunk: Gjs.byteArray.ByteArray) => void
    ): number;
    connect_after(
      sigName: "got-chunk",
      callback: ($obj: ServerMessage, chunk: Gjs.byteArray.ByteArray) => void
    ): number;
    emit(sigName: "got-chunk", chunk: Gjs.byteArray.ByteArray): void;
    connect(
      sigName: "got-headers",
      callback: ($obj: ServerMessage) => void
    ): number;
    ...
    connect(
      sigName: "wrote-body-data",
      callback: ($obj: ServerMessage, chunk_size: number) => void
    ): number;
    connect_after(
      sigName: "wrote-body-data",
      callback: ($obj: ServerMessage, chunk_size: number) => void
  ...
  export class Session {
    ...
    send_and_read_finish(result: Gio.AsyncResult): Gjs.byteArray.ByteArray;
    send_async(
      msg: Message,
      io_priority: number,
      cancellable?: Gio.Cancellable | null,
    ...
    connect(
      ...
      callback: ($obj: Session, msg: Message) => void
    ): number;
    connect_after(
      sigName: "request-queued",
      callback: ($obj: Session, msg: Message) => void
  ...
  export class WebsocketConnection {
    ...
    send_message(
      ...
      message: Gjs.byteArray.ByteArray
    ): void;
    ...
    connect(
      sigName: "closed",
      callback: ($obj: WebsocketConnection) => void
    ): number;
    connect_after(
      sigName: "closed",
      callback: ($obj: WebsocketConnection) => void
    ...
    connect(
      sigName: "error",
      callback: ($obj: WebsocketConnection, error: GLib.Error) => void
    ): number;
    connect_after(
      sigName: "error",
      callback: ($obj: WebsocketConnection, error: GLib.Error) => void
  ...
  export interface WebsocketExtension_ConstructProps
    extends GObject.Object_ConstructProps {}
  export class WebsocketExtension {
    ...
    process_incoming_message(
      header: number,
      payload: Gjs.byteArray.ByteArray
    ): Gjs.byteArray.ByteArray;
    ...
    connect(
      sigName: "notify",
      callback: ($obj: WebsocketExtension, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify",
      callback: ($obj: WebsocketExtension, pspec: GObject.ParamSpec) => void
  ...
  export interface WebsocketExtensionDeflate_ConstructProps
    extends WebsocketExtension_ConstructProps {}
  ...
  export interface WebsocketExtensionManager_ConstructProps
    extends GObject.Object_ConstructProps {}
  ...
  export class MessageBody {
    ...
    append_bytes(buffer: Gjs.byteArray.ByteArray): void;
    append(data: Gjs.byteArray.ByteArray): void;
    complete(): void;
    flatten(): Gjs.byteArray.ByteArray;
    get_accumulate(): boolean;
    get_chunk(offset: number): Gjs.byteArray.ByteArray;
    got_chunk(chunk: Gjs.byteArray.ByteArray): void;
    ref(): MessageBody;
    set_accumulate(accumulate: boolean): void;
    truncate(): void;
    unref(): void;
    wrote_chunk(chunk: Gjs.byteArray.ByteArray): void;
    static name: string;
  ...
  export class MessageMetrics {
    /* Methods of Soup.MessageMetrics */
    copy(): MessageMetrics;
    free(): void;
  ...
  export class Multipart {
    ...
    append_form_file(
      ...
      filename: string,
      content_type: string,
      body: Gjs.byteArray.ByteArray
    ): void;
    append_form_string(control_name: string, data: string): void;
    append_part(headers: MessageHeaders, body: Gjs.byteArray.ByteArray): void;
    free(): void;
    get_length(): number;
    get_part(
      part: number
    ...
    to_message(
      dest_headers: MessageHeaders
    ): /* dest_body */ Gjs.byteArray.ByteArray;
    static name: string;
  ...
  export abstract class ServerMessageClass {
    /* Fields of Soup.ServerMessageClass */
    parent_class: GObject.ObjectClass;
    static name: string;
  }
  ...
  export abstract class WebsocketExtensionClass {
    ...
    name: string;
    configure: any;
    get_request_params: any;
    get_response_params: any;
