...
declare namespace Soup {
  ...
  function uri_decode_data_uri(
    uri: string | null
  ): [/* returnType */ GLib.Bytes | null, /* content_type */ string | null];
  /**
   ...
   */
  function uri_equal(uri1: GLib.Uri | null, uri2: GLib.Uri | null): boolean;
  /**
  ...
  interface AuthDomainFilter {
    (domain: AuthDomain | null, msg: ServerMessage | null): boolean;
  }
  /**
  ...
  interface Auth {
     ...
     */
    get_protection_space(source_uri: GLib.Uri | null): string[] | null;
    /**
     ...
     * @returns the list of   paths, which can be freed with [method@Auth.free_protection_space].
     */
    vfunc_get_protection_space(source_uri: GLib.Uri | null): string[] | null;
    /**
  ...
  interface AuthDomain {
     ...
     */
    accepts(msg: ServerMessage | null): string | null;
    /**
     * Adds `path` to `domain`.
     *
     ...
     * @param msg a #SoupServerMessage
     */
    challenge(msg: ServerMessage | null): void;
    /**
     ...
     */
    covers(msg: ServerMessage | null): boolean;
    /**
     ...
     * @param msg a #SoupServerMessage
     */
    vfunc_challenge(msg: ServerMessage | null): string | null;
    /**
     * Checks if `msg` authenticates to `domain` via `username` and
     * `password`.
     *
  ...
  interface AuthManager extends SessionFeature {
     ...
     */
    use_auth(uri: GLib.Uri | null, auth: Auth | null): void;
  ...
  interface CookieJar extends SessionFeature {
     ...
     */
    get_cookie_list(uri: GLib.Uri | null, for_http: boolean): Cookie[] | null;
    /**
     ...
     */
    get_cookies(uri: GLib.Uri | null, for_http: boolean): string | null;
    /**
     ...
     */
    set_cookie(uri: GLib.Uri | null, cookie: string | null): void;
    /**
     * Adds `cookie` to `jar,` exactly as though it had appeared in a
     * Set-Cookie header returned from a request to `uri`.
     *
  ...
  interface Message {
     ...
     */
    get_request_headers(): MessageHeaders | null;
    /**
     * Returns the headers recieved with the response.
     * @returns The #SoupMessageHeaders
     */
    get_response_headers(): MessageHeaders | null;
    /**
     * Gets `msg'`s site for cookies #GUri.
     * @returns the @msg's site for cookies #GUri
     */
    get_site_for_cookies(): GLib.Uri | null;
    /**
     ...
     */
    set_first_party(first_party: GLib.Uri | null): void;
    /**
     ...
     */
    set_uri(uri: GLib.Uri | null): void;
    /**
    ...
    connect(
      ...
      callback: Message.AcceptCertificateSignalCallback
    ): number;
    connect_after(
      sigName: "accept-certificate",
      callback: Message.AcceptCertificateSignalCallback
    ...
    connect(
      ...
      callback: Message.AuthenticateSignalCallback
    ): number;
    connect_after(
      sigName: "authenticate",
      callback: Message.AuthenticateSignalCallback
    ...
    connect(
      ...
      callback: Message.HstsEnforcedSignalCallback
    ): number;
    connect_after(
      sigName: "hsts-enforced",
      callback: Message.HstsEnforcedSignalCallback
    ...
    connect(
      sigName: "request-certificate",
      callback: Message.RequestCertificateSignalCallback
    ): number;
    connect_after(
      sigName: "request-certificate",
      callback: Message.RequestCertificateSignalCallback
    ...
    emit(
      sigName: "request-certificate",
      tls_connection: Gio.TlsClientConnection,
      ...args: any[]
    ): void;
    connect(
      sigName: "request-certificate-password",
      callback: Message.RequestCertificatePasswordSignalCallback
    ): number;
    connect_after(
      sigName: "request-certificate-password",
      callback: Message.RequestCertificatePasswordSignalCallback
    ...
    connect(
      sigName: "notify::is-options-ping",
      callback: ($obj: Message, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::is-options-ping",
    ...
    connect(
      sigName: "notify::request-headers",
      callback: ($obj: Message, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::request-headers",
    ...
    connect(
      sigName: "notify::response-headers",
      callback: ($obj: Message, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::response-headers",
    ...
    connect(
      sigName: "notify::tls-ciphersuite-name",
      callback: ($obj: Message, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::tls-ciphersuite-name",
    ...
    connect(
      sigName: "notify::tls-peer-certificate",
      callback: ($obj: Message, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::tls-peer-certificate",
    ...
    connect(
      sigName: "notify::tls-peer-certificate-errors",
      callback: ($obj: Message, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::tls-peer-certificate-errors",
    ...
    connect(
      sigName: "notify::tls-protocol-version",
      callback: ($obj: Message, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::tls-protocol-version",
  ...
  class Message extends GObject.Object {
     ...
     */
    static new_from_encoded_form(
      method: string | null,
      uri_string: string | null,
      encoded_form: string | null
    ): Message;
    /**
     ...
     */
    static new_from_uri(method: string | null, uri: GLib.Uri | null): Message;
    /**
     ...
     * @returns the new #SoupMessage
     */
    static new_options_ping(base_uri: GLib.Uri | null): Message;
  ...
  interface Server {
     ...
     */
    pause_message(msg: ServerMessage | null): void;
    /**
     ...
     */
    set_tls_certificate(certificate: Gio.TlsCertificate | null): void;
    /**
     ...
     * @param msg a #SoupServerMessage associated with `server`.
     */
    unpause_message(msg: ServerMessage | null): void;

    // Own virtual methods of Soup-3.0.Soup.Server

    vfunc_request_aborted(msg: ServerMessage | null): void;
    vfunc_request_finished(msg: ServerMessage | null): void;
    vfunc_request_read(msg: ServerMessage | null): void;
    vfunc_request_started(msg: ServerMessage | null): void;
  ...
  interface ServerMessage {
     ...
     */
    get_request_body(): MessageBody | null;
    /**
     ...
     * @returns a #SoupMessageBody.
     */
    get_response_body(): MessageBody | null;
    /**
    ...
    connect(
      sigName: "accept-certificate",
      callback: ServerMessage.AcceptCertificateSignalCallback
    ): number;
    connect_after(
      sigName: "accept-certificate",
      callback: ServerMessage.AcceptCertificateSignalCallback
    ...
    connect(
      sigName: "connected",
      callback: ServerMessage.ConnectedSignalCallback
    ): number;
    connect_after(
      sigName: "connected",
      callback: ServerMessage.ConnectedSignalCallback
    ...
    connect(
      ...
      callback: ServerMessage.DisconnectedSignalCallback
    ): number;
    connect_after(
      sigName: "disconnected",
      callback: ServerMessage.DisconnectedSignalCallback
    ...
    connect(
      sigName: "finished",
      callback: ServerMessage.FinishedSignalCallback
    ): number;
    connect_after(
      sigName: "finished",
      callback: ServerMessage.FinishedSignalCallback
    ...
    connect(
      sigName: "got-body",
      callback: ServerMessage.GotBodySignalCallback
    ): number;
    connect_after(
      sigName: "got-body",
      callback: ServerMessage.GotBodySignalCallback
    ...
    connect(
      sigName: "got-chunk",
      callback: ServerMessage.GotChunkSignalCallback
    ): number;
    connect_after(
      sigName: "got-chunk",
      callback: ServerMessage.GotChunkSignalCallback
    ...
    connect(
      sigName: "got-headers",
      callback: ServerMessage.GotHeadersSignalCallback
    ): number;
    connect_after(
      sigName: "got-headers",
      callback: ServerMessage.GotHeadersSignalCallback
    ...
    connect(
      sigName: "wrote-body",
      callback: ServerMessage.WroteBodySignalCallback
    ): number;
    connect_after(
      sigName: "wrote-body",
      callback: ServerMessage.WroteBodySignalCallback
    ...
    connect(
      sigName: "wrote-body-data",
      callback: ServerMessage.WroteBodyDataSignalCallback
    ): number;
    connect_after(
      sigName: "wrote-body-data",
      callback: ServerMessage.WroteBodyDataSignalCallback
    ...
    connect(
      sigName: "wrote-chunk",
      callback: ServerMessage.WroteChunkSignalCallback
    ): number;
    connect_after(
      sigName: "wrote-chunk",
      callback: ServerMessage.WroteChunkSignalCallback
    ...
    connect(
      sigName: "wrote-headers",
      callback: ServerMessage.WroteHeadersSignalCallback
    ): number;
    connect_after(
      sigName: "wrote-headers",
      callback: ServerMessage.WroteHeadersSignalCallback
    ...
    connect(
      ...
      callback: ServerMessage.WroteInformationalSignalCallback
    ): number;
    connect_after(
      sigName: "wrote-informational",
      callback: ServerMessage.WroteInformationalSignalCallback
    ...
    connect(
      sigName: "notify::tls-peer-certificate",
      callback: ($obj: ServerMessage, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::tls-peer-certificate",
      callback: ($obj: ServerMessage, pspec: GObject.ParamSpec) => void
  ...
  interface Session {
     ...
     */
    get_async_result_message(result: Gio.AsyncResult | null): Message | null;
    /**
     ...
     */
    preconnect_finish(result: Gio.AsyncResult | null): boolean;
    /**
     ...
     * @returns a #GBytes, or %NULL on error.
     */
    send_and_read_finish(result: Gio.AsyncResult | null): GLib.Bytes | null;
    /**
    ...
    vfunc_request_queued(msg: Message | null): void;
    vfunc_request_unqueued(msg: Message | null): void;
    ...
    connect(
      sigName: "notify::remote-connectable",
      callback: ($obj: Session, pspec: GObject.ParamSpec) => void
    ): number;
    connect_after(
      sigName: "notify::remote-connectable",
  ...
  interface Cookie {
     ...
     */
    applies_to_uri(uri: GLib.Uri | null): boolean;
    /**
     * Copies `cookie`.
     ...
     */
    set_expires(expires: GLib.DateTime | null): void;
    /**
  ...
  interface MessageBody {
     ...
     */
    append_bytes(buffer: GLib.Bytes | null): void;
    /**
     ...
     */
    wrote_chunk(chunk: GLib.Bytes | null): void;
  }
  ...
  interface Multipart {
     ...
     */
    append_part(headers: MessageHeaders | null, body: GLib.Bytes | null): void;
    /**
     * Frees `multipart`.
     */
    free(): void;
  ...
  interface ServerClass {
    ...
    parent_class: GObject.ObjectClass;
    request_started: (server: Server | null, msg: ServerMessage | null) => void;
    request_read: (server: Server | null, msg: ServerMessage | null) => void;
    request_finished: (
      server: Server | null,
      msg: ServerMessage | null
    ) => void;
    request_aborted: (server: Server | null, msg: ServerMessage | null) => void;
    padding: any[];
  }
  ...
  interface SessionClass {
    ...
    parent_class: GObject.ObjectClass;
    request_queued: (session: Session | null, msg: Message | null) => void;
    request_unqueued: (session: Session | null, msg: Message | null) => void;
  }
