...
declare namespace Graphene {
  ...
  export class Simd4F {
    /* Fields of Graphene.Simd4F */
    static name: string;
  }
  export class Simd4X4F {
    /* Fields of Graphene.Simd4X4F */
    static name: string;
  }
  export class Size {
